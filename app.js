...
async function startCall(){
  ...
  try{
    ...
    const tr=audioTransceiver||pc.getTransceivers().find(t=>t.kind==='audio')||(function(){try{return pc.addTransceiver('audio',{direction:'sendrecv'})}catch{return null}})();
